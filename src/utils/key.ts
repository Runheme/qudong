  ...
  return [
    {
      ...
      keycodes: [
        ...
        {name: '右Shift', code: 'KC_RSFT', width: 2750, shortName: 'RShft'},
        {name: '左Ctrl', code: 'KC_LCTL', keys: 'ctrl', width: 1250},
        ...
        {name: '右Win', code: 'KC_RGUI', width: 1250, shortName: 'RWin'},
        {
          name: '左Alt',
          code: 'KC_LALT',
          keys: 'alt',
        ...
        {name: '右 Alt', code: 'KC_RALT', width: 1250, shortName: 'RAlt'},
        {name: 'Space', code: 'KC_SPC', keys: 'space', width: 6250},
        {name: 'Menu', code: 'KC_APP', width: 1250, shortName: 'RApp'},
        {name: '左', code: 'KC_LEFT', keys: 'left', shortName: '←'},
        {name: '下', code: 'KC_DOWN', keys: 'down', shortName: '↓'},
        {name: '上', code: 'KC_UP', keys: 'up', shortName: '↑'},
        {name: '右', code: 'KC_RGHT', keys: 'right', shortName: '→'},
      ],
    },
    // {
    //   id: 'wt_lighting',
    ...
    // },
    {
      ...
      width: 'label',
      keycodes: [
        {name: '音量 -', code: 'KC_VOLD', title: 'Volume Down'},
        {name: '音量 +', code: 'KC_VOLU', title: 'Volume Up'},
        {name: '静音', code: 'KC_MUTE', title: 'Mute Audio'},
        {name: '播放', code: 'KC_MPLY', title: 'Play/Pause'},
        {name: '停止', code: 'KC_MSTP', title: 'Media Stop'},
        {name: '上一首', code: 'KC_MPRV', title: 'Media Previous'},
        {name: '下一首', code: 'KC_MNXT', title: 'Media Next'},
    ...
    },
    {
      ...
      width: 'label',
      keycodes: [
        {name: '宏0', code: 'MACRO(0)', title: 'Macro 0'},
        {name: '宏1', code: 'MACRO(1)', title: 'Macro 1'},
        {name: '宏2', code: 'MACRO(2)', title: 'Macro 2'},
        {name: '宏3', code: 'MACRO(3)', title: 'Macro 3'},
        {name: '宏4', code: 'MACRO(4)', title: 'Macro 4'},
        {name: '宏5', code: 'MACRO(5)', title: 'Macro 5'},
        {name: '宏6', code: 'MACRO(6)', title: 'Macro 6'},
        {name: '宏7', code: 'MACRO(7)', title: 'Macro 7'},
        {name: '宏8', code: 'MACRO(8)', title: 'Macro 8'},
        {name: '宏9', code: 'MACRO(9)', title: 'Macro 9'},
        {name: '宏10', code: 'MACRO(10)', title: 'Macro 10'},
        {name: '宏11', code: 'MACRO(11)', title: 'Macro 11'},
        {name: '宏12', code: 'MACRO(12)', title: 'Macro 12'},
        {name: '宏13', code: 'MACRO(13)', title: 'Macro 13'},
        {name: '宏14', code: 'MACRO(14)', title: 'Macro 14'},
        {name: '宏15', code: 'MACRO(15)', title: 'Macro 15'},
      ],
    },
    buildLayerMenu(),
    {
      ...
      keycodes: [
        ...
        {name: '重置键', code: 'RESET', title: 'Reset the keyboard'},
        ...
        {name: '鼠标 Btn1', code: 'KC_MS_BTN1'},
        {name: '鼠标 Btn2', code: 'KC_MS_BTN2'},
        {name: '鼠标 Btn3', code: 'KC_MS_BTN3'},
        {name: '鼠标 Btn4', code: 'KC_MS_BTN4'},
        {name: '鼠标 Btn5', code: 'KC_MS_BTN5'},
        {name: '鼠标 Btn6', code: 'KC_MS_BTN6'},
        {name: '鼠标 Btn7', code: 'KC_MS_BTN7'},
        {name: '鼠标 Btn8', code: 'KC_MS_BTN8'},
        {name: '鼠标 Wh ↑', code: 'KC_MS_WH_UP'},
        {name: '鼠标 Wh ↓', code: 'KC_MS_WH_DOWN'},
        {name: '鼠标 Wh ←', code: 'KC_MS_WH_LEFT'},
        {name: '鼠标 Wh →', code: 'KC_MS_WH_RIGHT'},
        {name: '鼠标 Acc0', code: 'KC_MS_ACCEL0'},
        {name: '鼠标 Acc1', code: 'KC_MS_ACCEL1'},
        {name: '鼠标 Acc2', code: 'KC_MS_ACCEL2'},
